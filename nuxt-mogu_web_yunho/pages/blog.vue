        ...
        mounted () {
          ...
          getBlogByUid(params).then(response => {
            if (response.data.code == this.$ECode.SUCCESS) {
              ...
              this.blogUid = response.data.data.uid
              this.blogOid = response.data.data.oid
              this.commentInfo.blogUid = response.data.data.uid;
        ...
        methods: {
            ...
            setCommentAndAdmiration() {
              ...
              if(webConfigData && webConfigData.data && webConfigData.data.createTime) {
                this.openAdmiration = webConfigData.data.openAdmiration
